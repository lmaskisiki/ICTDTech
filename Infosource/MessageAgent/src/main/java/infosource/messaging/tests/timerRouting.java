package infosource.messaging.tests;
...
public class timerRouting {
	...
	public void sendMessage(String msg) {
		...
		// template.sendBody("direct:getApproved","");
			//template.sendBody("direct:doneApplication",new RequestResponseMessage().RequestApproved());
			Thread.sleep(9000);
			template.stop();
		} catch (Exception e) {
			e.printStackTrace();
