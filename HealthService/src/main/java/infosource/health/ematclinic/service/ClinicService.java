...
public ClinicService() {
	...
	/* CHECKUP OPERTION */
	/* (non-Javadoc)
	 * @see infosource.health.ematclinic.service.IClinicService#getCheckups()
	 */
	@Override
	@GET
	@Path("/getall")
	...
	/* (non-Javadoc)
	 * @see infosource.health.ematclinic.service.IClinicService#findById(java.lang.String)
	 */
	@Override
	@GET
	@Path("/find/{id}")
	...
	/* (non-Javadoc)
	 * @see infosource.health.ematclinic.service.IClinicService#saveAsJson(infosource.health.ematclinic.models.Checkup)
	 */
	@Override
	@POST
	@Path("/save1")
	...
	/* (non-Javadoc)
	 * @see infosource.health.ematclinic.service.IClinicService#saveAsObject(java.lang.String)
	 */
	@Override
	@POST
	@Path("/save")
