...
public   class GsonUTCdateAdapter implements
	...
	public synchronized Date deserialize(JsonElement jsonElement, Type type,
		 ...
		 try {
		 	...
		 	System.out.println("something is not right");throw new JsonParseException(e);
	 	 }
	//	System.out.println("Timestamp recieved :"+jsonElement.getAsLong());
	//long lng=jsonElement.getAsLong();
	//Date d= new Date(lng);
	//System.out.println("Date to submit :"+d);
	//	return d;
	}
}